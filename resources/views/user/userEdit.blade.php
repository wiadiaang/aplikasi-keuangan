                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="{{ route('user.update',$post->user_id)  }}"  method="POST" class="form-horizontal" >
                                                @csrf
                                                @method('PATCH') 
                                                <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="text" name="fullname" class="form-control" value="{{ old('full_name', $post->full_name) }}" placeholder="Enter text Fullname">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                @foreach ($entitas as $entitas)
                                                                        ...
                                                                        @if ( old('entitas_id', $post->entitas_id) ==$entitas->entitas_id)
                                                                            <option value="{{ $entitas->entitas_id }}" selected>{{ $entitas->entitas_name }}</option>
                                                                        @else
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="email" name="email" class="form-control"  value="{{ old('email', $post->email) }}" readonly placeholder="Enter text Email jhono@gmail.com">
                                                                <!-- <span class="help-block"> A block of help text. </span> -->
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="number" name="no_phone" class="form-control" value="{{ old('no_phone', $post->no_phone) }}" placeholder="Enter text Phone">
                                                                <!-- <span class="help-block"> A block of help text. </span> -->
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                @foreach ($role as $role)
                                                                    ...
                                                                    @if ( old('role_id', $post->role_id) == $role->role_id)
                                                                            ...
                                                                            <div class="icheck-list">
                                                                                <!-- <label>
                                                                                    <input type="checkbox" name="status"  class="icheck">  </label> -->
                                                                                            ...
                                                                                            @if ($post->status === true)
                                                                                                <input type="checkbox" name="status" checked value="{{ old('status', $post->status) }}" class="icheck">
                                                                                            @else
                                                                                                <input type="checkbox" name="status"  class="icheck">                                                                                              
                                                                                            @endif
